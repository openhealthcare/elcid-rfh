...
class PatientAdminTestCase(OpalTestCase):
    ...
    def test_upstream_appointments(self):
        r = "<a href='/intrahospital_api/raw/appointments/123'>Raw Appointments</a>"
        self.assertEqual(self.admin.upstream_appointments(self.patient), r)
